...
import ToppersBoard from './MyComponents/ToppersBoard';
import ToppersBoardPage from './MyComponents/ToppersBoardPage';
...
function App() {
  ...
  return (
    ...
    <Routes>
      ...
      <Route path="ToppersBoard" element={<ToppersBoardPage />}/>
    </Routes>
    </>
  );
}
