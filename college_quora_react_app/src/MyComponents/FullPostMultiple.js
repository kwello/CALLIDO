...
Index=0;
 state = {
    ...
    async  Delete(Post) {
        ...
        const response = await fetch('http://localhost:5000/posts/delete/'+Post._id, requestOptions);
...
async componentDidMount(){
  ...
  console.log('Post',this.state.Posts[0].UserID);
                 ...
                 <div className="card shadow-sm mb-3" style={{ "font-size": "14px" }}>
                    <div className="card-body pt3">
                        <div className="row">
                            ...
                            <div className="col">
                                <h6 className="text-primary flex-fill">
                          ...
                          {Post.UserID==this.state.UserID?<div className="col-auto">
                                <button onClick={()=>{this.Delete(Post)}} className="btn btn-primary btn-sm" type="button"><i className="fa fa-remove"></i></button>
                            </div>
                        ...
                        <p>~ {new Date(Post.PostDateTime).toLocaleDateString()}</p>
                            ...
                            {Post.Comments.map(Comment =>
                                <a className="list-group-item list-group-item-action pb-0 pt-3">
                                    <div className="row">
                                        ...
                                        <div className="col">
                                            <h6 className="text-primary flex-fill mb-0">
